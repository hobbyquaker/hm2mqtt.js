...
/** a failed init is retried after 2, 4, 8, 16 s, then every INIT_RETRY_MS (the cap) */
const INIT_BACKOFF_MS = [2000, 4000, 8000, 16000];
        ...
        try {
            ...
            if (msg !== this.lastInitError) {
                this.log.warn(
                    ...
                    'init failed:',
                    msg,
                    `- retrying in ${delay / 1000} s (then up to every ${INIT_RETRY_MS / 1000} s)`,
                );
