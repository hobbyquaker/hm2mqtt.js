...
| 7   | **Local mode** (H-37): `local` flag in `interfaceConfig()`, ReGa 8183, port-probe detection + `--local`, unit tests for the port map. Independent of the addon — do it first, it also makes a Docker-on-CCU install sane.                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 0.5 d  |
| 8   | Release notes: Installation/platform table in `.github/release-notes.js` (H-42), plus the `-beta` suffix handling of H-41 in the addon build.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 0.5 d  |
...
| OQ-62 | **Who tests the addon on real hardware** — the `-beta` suffix (H-41) only comes off with one confirmed install on a CCU3 with official firmware and one on OpenCCU. The user's own CCU3 is off limits for now.                                                                                                                                                                                                                                  | Ask in the RedMatic/homematic forum when the first package builds; until then ship `-beta` and say so in the release notes.                                                                                                                                                         |
